...
void app_main(void) {
ESP_LOGI(TAG,"Starting ADS1115 example..");
  // Setup I2C
...
// Setup mcp4725_t
mcp4725_set_voltage(mcp4725_t,2000); //100: 1.605v , 12 bit= 4095= 3.29v  
...
float vol = computeVolts(result);
ESP_LOGI(TAG,"Conversion Value: %d, measure voltage %f", result,vol);     
}
}
